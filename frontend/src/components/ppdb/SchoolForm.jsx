...
const InputField = ({ formData, handleChange, errors, label, name, type = 'text', placeholder, maxLength, required = true }) => (
  <div>
    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <InputField formData={formData} errors={errors} handleChange={handleChange} label="NPSN" name="npsn" placeholder="8 digit" maxLength={8} />
          <SelectField formData={formData} errors={errors} handleChange={handleChange} label="Tahun Lulus" name="tahun_lulus" options={tahunLulusOptions} />
          <div className="md:col-span-2"><InputField formData={formData} errors={errors} handleChange={handleChange} label="Nama Sekolah" name="nama_sekolah" placeholder="Sesuai ijazah" /></div>
      ...
      <div className="space-y-3 pt-3 border-t">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <InputField formData={formData} errors={errors} handleChange={handleChange} label="B. Indonesia" name="nilai_bahasa_indonesia" type="number" placeholder="0-100" />
          <InputField formData={formData} errors={errors} handleChange={handleChange} label="Matematika" name="nilai_matematika" type="number" placeholder="0-100" />
          <InputField formData={formData} errors={errors} handleChange={handleChange} label="IPA" name="nilai_ipa" type="number" placeholder="0-100" />
          <InputField formData={formData} errors={errors} handleChange={handleChange} label="B. Inggris" name="nilai_bahasa_inggris" type="number" placeholder="0-100" />
        </div>
      </div>
