    ...
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <SelectField label="Pendidikan" name="pendidikan_ayah" options={pendidikanOptions} />
          <SelectField label="Pekerjaan" name="pekerjaan_ayah" options={pekerjaanOptions} />
          <SelectField label="Penghasilan" name="penghasilan_ayah" options={penghasilanOptions} />
        </div>
      </div>
      ...
      <div className="space-y-3 pt-3 border-t">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <SelectField label="Pendidikan" name="pendidikan_ibu" options={pendidikanOptions} />
          <SelectField label="Pekerjaan" name="pekerjaan_ibu" options={pekerjaanOptions} />
          <SelectField label="Penghasilan" name="penghasilan_ibu" options={penghasilanOptions} />
        </div>
      </div>
      ...
      <div className="space-y-3 pt-3 border-t">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <InputField label="No. Telepon" name="telepon_ortu" type="tel" placeholder="08xxxxxxxxxx" />
          <div>
      ...
      <div className="space-y-3 pt-3 border-t">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <InputField label="Nama Wali" name="nama_wali" required={false} />
          <InputField label="No. Telepon Wali" name="telepon_wali" type="tel" placeholder="08xxxxxxxxxx" required={false} />
        </div>
      </div>
    </div>
  );
